...
public abstract class ReportConfig {
	 ...
	 *
	 */
	public static final String AUTH_URL = "http://data.altamira.com.br/security-oauth2-0.2.0-SNAPSHOT/authz/permission";
	
	/**
	 *
	 */
	public static final String DATA_BASE_URL = "http://data.altamira.com.br/data-rest-0.9.0-SNAPSHOT";
	/**
	 *
	 */
